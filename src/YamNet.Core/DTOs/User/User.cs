...
namespace YamNet.Client
{
    ...
    public class User : UserBasicInfo
    {
        ...
        /// <summary>
        /// Gets or sets the user's bio / summary.
        /// </summary>
        ...
        public UserCompany[] PreviousCompanies { get; set; }

        /// <summary>
        /// Gets or sets the past schools.
        /// </summary>
        [JsonProperty("schools")]
        public UserSchool[] Schools { get; set; }
